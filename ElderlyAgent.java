...
public final class ElderlyAgent implements Steppable	{
	 ...
	 */
    public ElderlyAgent(MKOne g, String homeTract, String workTract,
    ...
    public ElderlyAgent(MKOne g, int homeTract, int workTract,
			GeomPlanarGraphEdge startingEdge, GeomPlanarGraphEdge goalEdge) {
	}
   ...
   public void step(SimState state)	{
       ...
       boolean toWork2 = ((MKOne) state).goToWork2;
